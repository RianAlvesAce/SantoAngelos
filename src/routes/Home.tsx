...
import video from "../assets/videoDiacono.mp4"
...
const Home = () => {
  ...
  return (
    <>
      <Header />
      <div className="flex h-screen -z-10 lg:shadow-xl shadow-shadow-semi-black">

        <div className="w-1/2 h-full bg-bg1 bg-contain bg-fixed relative lg:block hidden">
          <div className="w-full h-full bg-secondary-color bg-opacity-50 backdrop-blur-sm flex justify-center items-center">

            <div className="w-1/2 h-min rounded flex justify-center items-center relative">
        ...
        <div className="lg:w-1/2 gap-20 lg:gap-0 h-full bg-white flex flex-col items-center justify-center">
          ...
          <div className="lg:bg-black w-4/5 lg:hidden lg:w-96 h-52 mt-32 rounded flex justify-center items-center relative">
            ...
            <video src={video} ref={videoMobileRef} onClick={handleVideoMobile} className="rounded-md"></video>
      ...
      <div className="min-h-screen mt-40 lg:mt-0 py-48 flex flex-col justify-center items-center gap-16">
        ...
        <div className="w-full flex gap-12 relative overflow-hidden h-72 items-center self-end">
          <div className="flex gap-12 absolute pl-5 lg:pl-20 transition left-0" ref={carrosselRef}>
      ...
      <div className="flex flex-col items-center justify-around min-h-screen pb-48 px-10 lg:px-0">
        <Title title="Faça Parte da Missão" />

        <p className="mt-10 mb-28 text-center lg:text-start">Caso tenha se interessado pela causa, faça sua doação ou se torne um voluntário</p>

        <div className="flex flex-col lg:flex-row gap-20 w-full lg:px-60 h-full">
          ...
          <div className="flex-1 flex flex-col items-center gap-10 h-full">
            ...
            <div className="p-10 rounded-2xl gap-10 flex flex-col bg-secondary-color text-white">
          ...
          <div className="flex-1 flex flex-col items-center gap-10">
            ...
            <div className="border border-secondary-color p-10 rounded-2xl gap-10 flex flex-col text-secondary-color h-full justify-between">
